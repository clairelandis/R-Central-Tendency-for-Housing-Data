...
hist(brooklyn_price)
abline(v=brooklyn_mean, col="blue", lwd=4)
abline(v=brooklyn_median, col="red", lwd=4)
abline(v=brooklyn_mode, col="yellow", lwd=2)


ggplot(brooklyn_one_bed, aes(x=brooklyn_price))+
xlab("Frequency")+
ylab("Brooklyn Price")+
geom_histogram(fill="white", color="black", stat="bin", binwidth=1000)+
geom_vline(data = brooklyn_price, aes(xintercept=brooklyn_mean, colour=stat), col="blue", lwd=2)+
geom_vline(xintercept=brooklyn_median, col="red", lwd=2)+
geom_vline(xintercept=brooklyn_mode,col="green",linetype="dotted", lwd=2)+
labs(title="Brooklyn 1 Bdrm Apartment Prices", subtitle=("Based on Data from StreeEasy.com"), )
